  ...
  if (isProbeOperation()) {
    ...
    if (! settings.probing.probeOn) {
      if (getProperty("probingType") == "Renishaw") {
        ...
        writeBlock(gFormat.format(65), "P" + 8703, "A1", "M1", "X" + "[#5041]"); // Zero move to turn on probe
      }
  ...
  if (isProbeOperation()) {
    if (!hasNextSection() || !(isProbeOperation(getNextSection()) && (getNextSection().getTool().number == tool.number))) {
      ...
      if (getProperty("probingType") == "Renishaw") {
        ...
        writeBlock(gFormat.format(65), "P" + 8703, "A1", "M2", "X" + "[#5041]"); // Zero move to turn off probe
      }
